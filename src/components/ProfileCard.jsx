          ...
          <div className="flex-1 w-full">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-4">
              ...
              <a
                ...
                className="inline-flex items-center px-4 py-2 bg-github-dark text-white rounded-lg hover:bg-opacity-90 transition"
              >
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 mb-4">
              ...
              {profile.blog && (
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center text-gray-700 hover:text-github-accent"
                >
                  <svg
                    className="w-5 h-5 mr-1"
                    fill="none"
